...
export class EditVideoPage {
  ...
  performEdit() {
    ...
    VideoEditor.createThumbnail(
      (result) => {
        ...
        //this.trimVideo(); //holger + seb edit
        this.transcodeVideo(options.fileUri);
      },
      (err) => {
  ...
  transcodeVideo(trimmedVideoPath) {
    ...
    let options = {
      ...
      outputFileName: "transcode_ionic_" + new Date().getTime(),
      outputFileType: VideoEditorOptions.OutputFileType.MPEG4,
      videoBitrate: ls['videoBitrate'] || 1333333, // holg seb favorite format
      ...
      optimizeForNetworkUse: false, //doesn't work on android holg seb   ls['optimizeForNetworkUse'] || true,
    ...
    VideoEditor.transcodeVideo(
      ...
      (err) => {
        console.log('transcodeVideo error, err: ' + JSON.stringify(err));
      },
      options
    );
  }
